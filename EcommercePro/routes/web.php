...
Route::get('/search_product_admin', [AdminController::class, 'search_product']);
...
Route::get('/vadduser', [AdminController::class, 'vadduser']);
...
Route::get('/slider', [AdminController::class, 'show_sliders']);
Route::get('/update_slider/{id}', [AdminController::class, 'update_slider']);
...
Route::get('/cancel_cart/{id}', [HomeController::class, 'cancel_cart']);
